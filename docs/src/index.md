...
* *Incoherent Quantum error correction:*
  ...
  This problem is closely connected to tensor networks[cite], which can be solved with existing tools such as [`TensorInference.jl`](https://github.com/TensorBFS/TensorInference.jl). Examples are given in the following sections:
